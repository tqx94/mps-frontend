              ...
              <div className="lg:col-span-2">
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    {!checkingSeats && extendedHours > 0 && (DEMO_LAYOUT.length - occupiedSeats.length) > 0 && booking.pax > (DEMO_LAYOUT.length - occupiedSeats.length) && (
                      <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                        <div className="flex items-center">
                          <AlertTriangle className="h-5 w-5 text-red-500 mr-2" />
                          <div>
                            ...
                            <p className="text-sm text-red-700">
                              There are only {DEMO_LAYOUT.length - occupiedSeats.length} seats available. Please select another timeslot.
                            </p>
                          </div>
                        </div>
                      </div>
